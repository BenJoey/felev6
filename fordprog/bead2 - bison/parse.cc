// Generated by Bisonc++ V5.02.00 on Wed, 20 Mar 2019 20:34:53 +0100
...
PI__ const s_productionInfo[] = 
{
     ...
     {294, 3}, // 2: program ->  header declarations body
     {295, 2}, // 3: header (PROGRAM) ->  PROGRAM IDENTIFIER
     {296, 0}, // 4: declarations ->  <empty>
     {296, 2}, // 5: declarations ->  declaration declarations
     {298, 3}, // 6: declaration (IDENTIFIER) ->  type IDENTIFIER SEMICOLON
     {299, 1}, // 7: type (NATURAL) ->  NATURAL
     {299, 1}, // 8: type (BOOLEAN) ->  BOOLEAN
     {297, 3}, // 9: body (TBEGIN) ->  TBEGIN statements TEND
     {300, 1}, // 10: statements ->  statement
     {300, 2}, // 11: statements ->  statement statements
     {301, 1}, // 12: statement ->  skip
     {301, 1}, // 13: statement ->  assignment
     {301, 1}, // 14: statement ->  write
     {301, 1}, // 15: statement ->  read
     {301, 1}, // 16: statement ->  while_loop
     {301, 1}, // 17: statement ->  conditional
     {302, 2}, // 18: skip (SKIP) ->  SKIP SEMICOLON
     {303, 4}, // 19: assignment (IDENTIFIER) ->  IDENTIFIER ASSIGN expr SEMICOLON
     {304, 5}, // 20: write (WRITE) ->  WRITE LEFT_BRACKET expr RIGHT_BRACKET SEMICOLON
     {305, 5}, // 21: read (READ) ->  READ LEFT_BRACKET IDENTIFIER RIGHT_BRACKET SEMICOLON
     {306, 5}, // 22: while_loop (WHILE) ->  WHILE expr DO statements DONE
     {307, 6}, // 23: conditional (IF) ->  IF expr THEN statements elseifs ENDIF
     {307, 8}, // 24: conditional (IF) ->  IF expr THEN statements elseifs ELSE statements ENDIF
     {309, 0}, // 25: elseifs ->  <empty>
     {309, 5}, // 26: elseifs (ELSEIF) ->  ELSEIF expr THEN statements elseifs
     {308, 1}, // 27: expr (TRUE) ->  TRUE
     {308, 1}, // 28: expr (FALSE) ->  FALSE
     {308, 1}, // 29: expr (NATURAL_LITERAL) ->  NATURAL_LITERAL
     {308, 1}, // 30: expr (IDENTIFIER) ->  IDENTIFIER
     {308, 3}, // 31: expr (EQUALS) ->  expr EQUALS expr
     {308, 3}, // 32: expr (LEFT_BRACKET) ->  LEFT_BRACKET expr RIGHT_BRACKET
     {308, 2}, // 33: expr (NOT) ->  NOT expr
     {308, 3}, // 34: expr (AND) ->  expr AND expr
     {308, 3}, // 35: expr (OR) ->  expr OR expr
     {308, 3}, // 36: expr (LESS_THAN) ->  expr LESS_THAN expr
     {308, 3}, // 37: expr (GREATER_THAN) ->  expr GREATER_THAN expr
     {308, 3}, // 38: expr (PLUS) ->  expr PLUS expr
     {308, 3}, // 39: expr (MINUS) ->  expr MINUS expr
     {308, 3}, // 40: expr (ASTERIKS) ->  expr ASTERIKS expr
     {308, 3}, // 41: expr (MOD) ->  expr MOD expr
     {308, 3}, // 42: expr (DIV) ->  expr DIV expr
